  ...
  return (
    ...
    <div>
     <div className="relative  m-auto">
      <input placeholder="search" className="outline-0 placeholder:font-light w-[90vw] md:w-[50vw] p-1 border border-gray-300 rounded-[10px]" />
     <span className="absolute icon right-[2vw] text-[#13a6c7d1] top-[1.5vh] md:right-[1vw] md:top-[1.5vh] focus:hidden"><FaSistrix/></span>
    </div>
    </div>
    {/* <div className='text-center flex flex-col z-[100] overflow-y-auto'>
